...
export default function CloudNavigationPage() {
  return (
    <main className="min-h-screen bg-[#f4f3ee] text-[#111111]">
      ...
      >
        <Reveal>
          ...
          <p className="mt-8 max-w-3xl text-xl leading-9 text-neutral-600 sm:text-2xl">
            A navigation concept exploring how people could discover, revisit
            and move between services in a large cloud ecosystem.
          </p>
          ...
          <div className="mt-5 flex max-w-4xl items-start gap-3 text-sm leading-6 text-neutral-500">
            <span
              aria-hidden="true"
              className="mt-2 h-2 w-2 shrink-0 rounded-full bg-[#3d5f8d]"
            />
            <p>
              This independent concept was not commissioned by or affiliated
              with Google.
            </p>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.1} className="mt-16">
          <div className="overflow-hidden rounded-4xl bg-[#dce3ec] p-5 sm:p-10 lg:p-14">
              ...
              <div className="grid min-h-125 lg:grid-cols-[0.28fr_1fr]">
                <aside className="border-b border-black/10 bg-[#edf0f4] p-5 lg:border-b-0 lg:border-r">
                  ...
                  <div className="mt-6 space-y-2">
                    {["Overview", "All services", "Recent", "Saved", "Projects"].map(
                      (item, index) => (
                        <div
                          key={item}
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-10 px-6 py-24 sm:px-8 lg:grid-cols-[0.35fr_1fr] lg:px-10 lg:py-32">
          ...
          <Reveal delay={0.1}>
            ...
            <div className="mt-10 grid gap-6 text-lg leading-8 text-neutral-600 sm:grid-cols-2">
              ...
              <p>
                The concept explores how navigation could support both new
                users who browse and experienced users who move quickly
                between familiar tools.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="mx-auto w-full max-w-6xl">
          <Reveal>
            ...
            <p className="mt-8 max-w-5xl text-4xl font-medium leading-tight tracking-tight sm:text-6xl">
              How might we help people discover and move between cloud
              services without requiring them to memorize the platform?
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="mx-auto w-full max-w-6xl">
          <div className="grid gap-10 lg:grid-cols-[0.35fr_1fr]">
            ...
            <div>
              <Reveal delay={0.1}>
                <h2 className="max-w-3xl text-4xl font-semibold leading-tight tracking-tight sm:text-6xl">
                  Treat navigation as a connected system of finding
                  strategies.
                </h2>
              </Reveal>
      ...
      <section
        id="principles"
        className="scroll-mt-24 bg-[#dce3ec] px-6 py-24 sm:px-8 lg:px-10 lg:py-32"
      >
        <div className="mx-auto w-full max-w-6xl">
          <Reveal>
